<?php
  ...
  if (!preg_match("/^3[0-4]$/",$company,$ms)){print "ERROR: Wrong company code provided: $company\n"; return;}
  if (!preg_match("/^([2-9][0-9]|[1-9][0-9]{2,3})$/",$amount,$ms)){print "ERROR: Wrong amount provided: $amount\n"; return;}
  $data{'number'}=$number;
